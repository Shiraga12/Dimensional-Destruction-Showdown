...
/// @param {struct.CharacterData}		_RIVAL				-	The rival character.
...
function CharacterData(_NAME, _DESCRIPTION, _SERIES, _TYPE, _MOVES = [], _SPRITES = {},_SEQUENCES = {}, _VA = "N/A", _RIVAL = "N/A", _FIRST_APPEARANCE = "N/A", _ARCHETYPE = "N/A", _LOCKED = false) constructor{
	...
	static hasSPRITE				=	function(_SPRITE)				{	return struct_exists(SPRITES,_SPRITE)		};
	static hasSEQUENCE				=	function(_SEQUENCE)				{	return struct_exists(SEQUENCES,_SEQUENCE)	};
